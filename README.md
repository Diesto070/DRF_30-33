...
Создайте виртуальную машину, подключитесь к ней. В рамках учебного проекта сервер развернут на базе Яндекс.Cloud по адресу: http://158.160.92.14/

1. Подключение к серверу    
    ```ssh diesto070@158.160.92.14```
